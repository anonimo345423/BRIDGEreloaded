...
while (!empty(explode("\n", $output)[$i])) {
  ...
  if (!($cognome1 == $cognome2 && $nome1 == $nome2 && $percent == 100)&&$percent>20){
...
$grafico=str_replace("width=","",$grafico); //tolgo height e width messi da graphviz
        ...
        <div class="container-fluid pt-5">
          ...
          <div class="row text-center">
            <div class="col-12">
              <?php
              echo $grafico;
              if(empty($grafico)) echo "Non c'è codice simile fra gli studenti";
              unlink("input.dot");
              ?>
              </div>
          </div>
